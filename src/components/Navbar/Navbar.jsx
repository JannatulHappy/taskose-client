      ...
      <NavLink
        ...
        className={({ isActive, isPending }) =>
          isPending
            ? "pending"
            : isActive
            ? "active hover:border-b-2 border-b-blue-600  text-blue-400 text-lg md:text-xl mx-3 rounded-none font-semibold border-b-2"
            : "hover:border-b-2 border-b-blue-600  text-blue-500  text-lg md:text-xl mx-3 rounded-none"
        }
      >
        Home
      </NavLink>
      ...
      <div className="shadow-lg font-poppins ">
        <div className="px-4 mx-auto max-w-7xl">
          <nav className="flex items-center justify-between py-4">
            <Link
              to="/"
              className="flex gap-2 mb-4 text-xl font-bold text-blue-400 "
            >
            ...
            <div className="flex justify-between lg:space-x-9">
              ...
              <ul
                className={`hidden lg:w-auto lg:space-x-9 lg:items-center lg:flex `}
              >
                {navlinks}
                {/* <li>
                           {
          ...
          {open && (
            ...
            >
              ...
              <ul className="flex flex-col px-4 text-left mt-7">{navlinks}</ul>
            </div>
          )}
        </div>
      </div>
