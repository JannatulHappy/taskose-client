...
const UsersAndBenefits = () => {
    ...
    <div className="bg-blue-50">
      {/* <div className='flex items-center justify-center my-12 overflow-hidden bg-gray-100'>
				<div className='px-4 py-10 mx-auto lg:py-20 max-w-7xl'>
					...
					<div className='grid grid-cols-1 gap-4 lg:gap-8 md:grid-cols-2 lg:grid-cols-3'>
						...
						<motion.div
							...
							className='w-full p-8 transition-all bg-white rounded shadow hover:shadow-lg'>
							<div className='inline-block p-4 mb-6 bg-blue-400 rounded-full'>
								<FcManager className='text-3xl text-white' />
							</div>
						...
						<motion.div
							...
							className='w-full p-8 transition-all bg-white rounded shadow -700 hover:shadow-lg'>
							<div className='inline-block p-4 mb-6 bg-blue-400 rounded-full'>
								<SiFreelancer className='text-3xl text-white' />
							</div>
      ...
      {/* benefit Section */}
      <div className="flex items-center justify-center my-12 overflow-hidden">
        <div className="px-4 py-10 mx-auto lg:py-20 max-w-7xl">
          <div className="max-w-xl mx-auto">
            <h1 className="mb-4 text-4xl font-bold text-center text-blue-400">
              Who Get Benefits ?
            </h1>
            <p className="mb-16 text-base text-center text-gray-500">
              Elevate productivity for developers, professionals, bankers & more
              with our versatile task management app. Simplify your workflow
              today!
            </p>
          </div>
          <div className="grid grid-cols-1 gap-4 lg:gap-8 md:grid-cols-2 lg:grid-cols-3">
            <motion.div
              whileHover={{ scale: 1.1 }}
              data-aos="fade-right"
              className="w-full p-8 transition-all bg-blue-400 rounded shadow hover:shadow-lg"
            >
              <div className="inline-block p-4 mb-6 bg-white rounded-full">
              ...
              <p className="text-base text-gray-600 ">
                Organize your day, prioritize tasks, and meet deadlines with
                ease.
              </p>
            </motion.div>
            ...
            >
              <div className="inline-block p-4 mb-6 bg-white rounded-full">
                <FcManager className="text-3xl text-blue-400" />
              </div>
              <h3 className="mb-4 text-2xl font-semibold ">
                {" "}
                Project Managers{" "}
              </h3>
              <p className="text-base text-gray-600 -400">
                Track project progress, assign tasks, and collaborate with teams
                effectively.
              </p>
            </motion.div>
            ...
            <motion.div
              whileHover={{ scale: 1.1 }}
              data-aos="fade-left"
              className="w-full p-8 transition-all bg-blue-400 rounded shadow -700 hover:shadow-lg"
            >
              <div className="inline-block p-4 mb-6 bg-white rounded-full">
                <GrUserWorker className="text-3xl text-blue-400" />
              </div>
              <h3 className="mb-4 text-2xl font-semibold "> Remote Workers </h3>
              <p className="text-base text-gray-600 -400">
                Stay on top of work remotely, manage time zones, and collaborate
                seamlessly.
              </p>
            </motion.div>
            ...
            >
              <div className="inline-block p-4 mb-6 bg-white rounded-full">
                <PiStudentBold className="text-3xl text-blue-400" />
              </div>
              <h3 className="mb-4 text-2xl font-semibold "> Students </h3>
              <p className="text-base text-gray-600 -400">
                Plan assignments, study schedules, and stay organized for
                academic success.
              </p>
            </motion.div>
            <motion.div
            ...
            >
              <div className="inline-block p-4 mb-6 bg-white rounded-full">
                <SiFreelancer className="text-3xl text-blue-400" />
              </div>
              <h3 className="mb-4 text-2xl font-semibold "> Freelancers </h3>
              <p className="text-base text-gray-600 -400">
                Manage multiple projects, track billable hours, and meet client
                deadlines.
              </p>
            </motion.div>
            <motion.div
            ...
            >
              ...
              <p className="text-base text-gray-600 -400">
                Delegate tasks, track team productivity, and streamline
                operations.
              </p>
            </motion.div>
          </div>
