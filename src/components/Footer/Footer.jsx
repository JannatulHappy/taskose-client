...
const Footer = () => {
	...
	return (
    <>
      <div className="flex flex-col mt-12 overflow-hidden lg:justify-end font-poppins">
        <div className="w-full p-2 bg-black pt-11">
          <div className="justify-center flex-1 py-4 mx-auto max-w-7xl lg:py-0">
          ...
          <div className="py-5 text-center text-gray-400 bg-black ">
